...
Route::group('/auth', function () {
    ...
    Route::rule('/ruleAdd', 'admin/rbac/addRule', 'POST')->middleware('\xiaodi\Permission\Middlewares\Permission', 'rule-add');
    Route::rule('/rule/:id', 'admin/rbac/updateRule', 'PUT')->middleware('\xiaodi\Permission\Middlewares\Permission', 'rule-update');
    ...
    Route::rule('/roleAdd', 'admin/rbac/addRole', 'POST')->middleware('\xiaodi\Permission\Middlewares\Permission', 'role-add');
    ...
    Route::rule('/userAdd', 'admin/rbac/addUser', 'POST')->middleware('\xiaodi\Permission\Middlewares\Permission', 'account-add');
