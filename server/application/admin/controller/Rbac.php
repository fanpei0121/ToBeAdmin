...
class Rbac extends Base
{
     ...
     * @return void
     */
    public function roles($page = 1, $pageSize = 10)
    {
     ...
     * @return void
     */
    public function rules($page = 1, $pageSize = 10)
    {
    ...
    public function _ajaxTree()
    {
        ...
        $where["pid"] = 0;
        $where["status"] = 1;
        $list = Db::table("auth_permission")->where($where)->select();
        foreach ($list as &$v) {
            $v["cname"] = $v["title"];
        }
     ...
     * @return void
     */
    public function users($page = 1, $pageSize = 10)
    {
        try {
